...
describe('Classe de l\'interface de commande en ligne Cli', () => {
    ...
    it('On test qu\'une erreur est bien intercepté quand il n\'y a pas de commandes disponibles', (done) => {
        ...
        cli.run(badEnvironment).then(function (result: any) {
            expect(true).toBe(true);
            expect(result).toEqual('The specified command is invalid. For available options, see `mw help`.');
            done();
        });
    });
    ...
    it('On test que quand aucune commande n\'est passé en paramètre (juste mw), c\'est la commande help par défaut qui est lancé', (done) => {
        cli.run(environment).then(function (result: any) {
            expect(true).toBe(true);
            expect(result).toEqual(0);
            done();
    ...
    it('On test que quand \'mw --help\' est passé en paramètre, c\'est la commande help qui est lancé', (done) => {
    ...
    it('On test que quand \'mw macommande --help\' est passé en paramètre, c\'est la commande help de la commande \'macommande\' qui est lancé', (done) => {
